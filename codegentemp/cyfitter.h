...
/* AIR_enable */
#define AIR_enable__0__INTTYPE CYREG_PICU2_INTTYPE6
#define AIR_enable__0__MASK 0x40u
#define AIR_enable__0__PC CYREG_PRT2_PC6
#define AIR_enable__0__PORT 2u
#define AIR_enable__0__SHIFT 6u
#define AIR_enable__AG CYREG_PRT2_AG
#define AIR_enable__AMUX CYREG_PRT2_AMUX
#define AIR_enable__BIE CYREG_PRT2_BIE
#define AIR_enable__BIT_MASK CYREG_PRT2_BIT_MASK
#define AIR_enable__BYP CYREG_PRT2_BYP
#define AIR_enable__CTL CYREG_PRT2_CTL
#define AIR_enable__DM0 CYREG_PRT2_DM0
#define AIR_enable__DM1 CYREG_PRT2_DM1
#define AIR_enable__DM2 CYREG_PRT2_DM2
#define AIR_enable__DR CYREG_PRT2_DR
#define AIR_enable__INP_DIS CYREG_PRT2_INP_DIS
#define AIR_enable__INTTYPE_BASE CYDEV_PICU_INTTYPE_PICU2_BASE
#define AIR_enable__LCD_COM_SEG CYREG_PRT2_LCD_COM_SEG
#define AIR_enable__LCD_EN CYREG_PRT2_LCD_EN
#define AIR_enable__MASK 0x40u
#define AIR_enable__PORT 2u
#define AIR_enable__PRT CYREG_PRT2_PRT
#define AIR_enable__PRTDSI__CAPS_SEL CYREG_PRT2_CAPS_SEL
#define AIR_enable__PRTDSI__DBL_SYNC_IN CYREG_PRT2_DBL_SYNC_IN
#define AIR_enable__PRTDSI__OE_SEL0 CYREG_PRT2_OE_SEL0
#define AIR_enable__PRTDSI__OE_SEL1 CYREG_PRT2_OE_SEL1
#define AIR_enable__PRTDSI__OUT_SEL0 CYREG_PRT2_OUT_SEL0
#define AIR_enable__PRTDSI__OUT_SEL1 CYREG_PRT2_OUT_SEL1
#define AIR_enable__PRTDSI__SYNC_OUT CYREG_PRT2_SYNC_OUT
#define AIR_enable__PS CYREG_PRT2_PS
#define AIR_enable__SHIFT 6u
#define AIR_enable__SLW CYREG_PRT2_SLW

/* Selector_In */
#define Selector_In__0__INTTYPE CYREG_PICU2_INTTYPE0
#define Selector_In__0__MASK 0x01u
#define Selector_In__0__PC CYREG_PRT2_PC0
#define Selector_In__0__PORT 2u
#define Selector_In__0__SHIFT 0u
#define Selector_In__1__INTTYPE CYREG_PICU2_INTTYPE1
#define Selector_In__1__MASK 0x02u
#define Selector_In__1__PC CYREG_PRT2_PC1
#define Selector_In__1__PORT 2u
#define Selector_In__1__SHIFT 1u
#define Selector_In__2__INTTYPE CYREG_PICU2_INTTYPE2
#define Selector_In__2__MASK 0x04u
#define Selector_In__2__PC CYREG_PRT2_PC2
#define Selector_In__2__PORT 2u
#define Selector_In__2__SHIFT 2u
#define Selector_In__3__INTTYPE CYREG_PICU2_INTTYPE3
#define Selector_In__3__MASK 0x08u
#define Selector_In__3__PC CYREG_PRT2_PC3
#define Selector_In__3__PORT 2u
#define Selector_In__3__SHIFT 3u
#define Selector_In__4__INTTYPE CYREG_PICU2_INTTYPE4
#define Selector_In__4__MASK 0x10u
#define Selector_In__4__PC CYREG_PRT2_PC4
#define Selector_In__4__PORT 2u
#define Selector_In__4__SHIFT 4u
#define Selector_In__5__INTTYPE CYREG_PICU2_INTTYPE5
#define Selector_In__5__MASK 0x20u
#define Selector_In__5__PC CYREG_PRT2_PC5
#define Selector_In__5__PORT 2u
#define Selector_In__5__SHIFT 5u
#define Selector_In__AG CYREG_PRT2_AG
#define Selector_In__AMUX CYREG_PRT2_AMUX
#define Selector_In__BIE CYREG_PRT2_BIE
#define Selector_In__BIT_MASK CYREG_PRT2_BIT_MASK
#define Selector_In__BYP CYREG_PRT2_BYP
#define Selector_In__CTL CYREG_PRT2_CTL
#define Selector_In__DM0 CYREG_PRT2_DM0
#define Selector_In__DM1 CYREG_PRT2_DM1
#define Selector_In__DM2 CYREG_PRT2_DM2
#define Selector_In__DR CYREG_PRT2_DR
#define Selector_In__INP_DIS CYREG_PRT2_INP_DIS
#define Selector_In__INTTYPE_BASE CYDEV_PICU_INTTYPE_PICU2_BASE
#define Selector_In__LCD_COM_SEG CYREG_PRT2_LCD_COM_SEG
#define Selector_In__LCD_EN CYREG_PRT2_LCD_EN
#define Selector_In__MASK 0x3Fu
#define Selector_In__PORT 2u
#define Selector_In__PRT CYREG_PRT2_PRT
#define Selector_In__PRTDSI__CAPS_SEL CYREG_PRT2_CAPS_SEL
#define Selector_In__PRTDSI__DBL_SYNC_IN CYREG_PRT2_DBL_SYNC_IN
#define Selector_In__PRTDSI__OE_SEL0 CYREG_PRT2_OE_SEL0
#define Selector_In__PRTDSI__OE_SEL1 CYREG_PRT2_OE_SEL1
#define Selector_In__PRTDSI__OUT_SEL0 CYREG_PRT2_OUT_SEL0
#define Selector_In__PRTDSI__OUT_SEL1 CYREG_PRT2_OUT_SEL1
#define Selector_In__PRTDSI__SYNC_OUT CYREG_PRT2_SYNC_OUT
#define Selector_In__PS CYREG_PRT2_PS
#define Selector_In__SHIFT 0u
#define Selector_In__SLW CYREG_PRT2_SLW

/* Boost_Button */
#define Boost_Button__0__INTTYPE CYREG_PICU2_INTTYPE7
#define Boost_Button__0__MASK 0x80u
#define Boost_Button__0__PC CYREG_PRT2_PC7
#define Boost_Button__0__PORT 2u
#define Boost_Button__0__SHIFT 7u
#define Boost_Button__AG CYREG_PRT2_AG
#define Boost_Button__AMUX CYREG_PRT2_AMUX
#define Boost_Button__BIE CYREG_PRT2_BIE
#define Boost_Button__BIT_MASK CYREG_PRT2_BIT_MASK
#define Boost_Button__BYP CYREG_PRT2_BYP
#define Boost_Button__CTL CYREG_PRT2_CTL
#define Boost_Button__DM0 CYREG_PRT2_DM0
#define Boost_Button__DM1 CYREG_PRT2_DM1
#define Boost_Button__DM2 CYREG_PRT2_DM2
#define Boost_Button__DR CYREG_PRT2_DR
#define Boost_Button__INP_DIS CYREG_PRT2_INP_DIS
#define Boost_Button__INTTYPE_BASE CYDEV_PICU_INTTYPE_PICU2_BASE
#define Boost_Button__LCD_COM_SEG CYREG_PRT2_LCD_COM_SEG
#define Boost_Button__LCD_EN CYREG_PRT2_LCD_EN
#define Boost_Button__MASK 0x80u
#define Boost_Button__PORT 2u
#define Boost_Button__PRT CYREG_PRT2_PRT
#define Boost_Button__PRTDSI__CAPS_SEL CYREG_PRT2_CAPS_SEL
#define Boost_Button__PRTDSI__DBL_SYNC_IN CYREG_PRT2_DBL_SYNC_IN
#define Boost_Button__PRTDSI__OE_SEL0 CYREG_PRT2_OE_SEL0
#define Boost_Button__PRTDSI__OE_SEL1 CYREG_PRT2_OE_SEL1
#define Boost_Button__PRTDSI__OUT_SEL0 CYREG_PRT2_OUT_SEL0
#define Boost_Button__PRTDSI__OUT_SEL1 CYREG_PRT2_OUT_SEL1
#define Boost_Button__PRTDSI__SYNC_OUT CYREG_PRT2_SYNC_OUT
#define Boost_Button__PS CYREG_PRT2_PS
#define Boost_Button__SHIFT 7u
#define Boost_Button__SLW CYREG_PRT2_SLW
