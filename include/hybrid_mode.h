...
#define MIN_VSS_TO_DEPLOY 0u//3u
#define MAX_VSS_TO_DEPLOY 85u
#define LAUNCH_MAX_RPM 9000u
#define LAUNCH_MAX_VSS 50u
#define LAUNCH_MIN_TPS 80u
#define ALWAYS_REGEN_TPS_THRESHOLD 20u
#define MAPPING_TPS_THRESHOLD 30u
/* __________ ESC MODES __________ */
#define FREEWHEEL_MODE 0u
#define TORQUE_MODE 3u//2u
