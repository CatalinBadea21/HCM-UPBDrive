...
void CAN_TxCancel(uint8 bufferId) 
{
    ...
    /*******************************************************************************
    * FUNCTION NAME:   CAN_SendMsgESC_control
    ********************************************************************************
    *
    * Summary:
    ...
    *
    *******************************************************************************/
    uint8 CAN_SendMsgESC_control(void) 
    {
        uint8 result = CYRET_SUCCESS;
            ...
            {
                /* `#START MESSAGE_ESC_control_TRASMITTED` */

                /* `#END` */

                #ifdef CAN_SEND_MSG_ESC_control_CALLBACK
                    CAN_SendMsg_ESC_control_Callback();
                #endif /* CAN_SEND_MSG_ESC_control_CALLBACK */
...
void CAN_ReceiveMsg(uint8 rxMailbox) 
{
    ...
    /*******************************************************************************
    * FUNCTION NAME:   CAN_ReceiveMsgECU_receive
    ********************************************************************************
    *
    * Summary:
    ...
    *
    *******************************************************************************/
    void CAN_ReceiveMsgECU_receive(void) 
    {
        /* `#START MESSAGE_ECU_receive_RECEIVED` */

        /* `#END` */

        #ifdef CAN_RECEIVE_MSG_ECU_receive_CALLBACK
            CAN_ReceiveMsg_ECU_receive_Callback();
        #endif /* CAN_RECEIVE_MSG_ECU_receive_CALLBACK */
